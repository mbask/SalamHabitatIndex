...
La media e la deviazione standard sulle `r sprintf("%d", resamplingCount)` simulazioni della correlazione tra indice e numero salamandre, per ciascun indice (`Df` è la dimensione frattale, `RIndex` è l'indice di A.Romano) sono le seguenti:
